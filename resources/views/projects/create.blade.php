    ...
    <div class="container-fluid" >
      <div class="columns row" >
        <div class="column is-4-desktop is-6-tablet is-7-mobile" >
          <button type="submit" class="w-100 btn btn-info bg-info btn-solid-{{ $sc_theme }}" form="create" >
            Create new project
          </button >
        </div >
        <div class="column is-2-desktop is-4-tablet  is-5-mobile" >
          <a href="{{ action('ProjectsController@index') }}" >
            <button class="w-100 btn btn-secondary bg-secondary btn-solid-{{ $sc_theme }}" >
              Cancel
            </button >
          </a >
        </div >
