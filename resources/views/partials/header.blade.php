...
<nav class="navbar navbar-expand-sm navbar-light bg-" >
  ...
  <div class="collapse navbar-collapse justify-content-end mr-5" id="nav-content" >
    <ul class="navbar-nav" >
      <li class="nav-item" >
        <a class="nav-link <?php if (strpos($activeTab, "home"))
            echo "active" ?>" href="/" >Home</a >
      </li >
      <li class="nav-item" >
        <a class="nav-link <?php if (strpos($activeTab, "projects"))
            echo "active" ?>" href="/projects" >Projects</a >
      </li >
      <li class="nav-item" >
        <a class="nav-link <?php if (strpos($activeTab, "about"))
            echo "active" ?>" href="/about" >About</a >
      </li >
      <li class="nav-item" >
        <a class="nav-link <?php if (strpos($activeTab, "contact"))
    ...
    <ul class="navbar-nav">
      ...
      @else
        <li class="nav-item dropdown is-paddingless is-marginless" >
          <a id="navbarDropdown"
            ...
            @endif
            <img src="{{ $sc_adorableAvatar }}" alt="" class="mr-2 ml-1 position-relative rounded-circle" >
            {{ Auth::user()->username }}
